...
if [ "$GRIP_CAL" == "1016" ]; then
    ...
    echo 0x200 0x8001 0x0000 0xffff 0x1400 0x0001 0x0000 > /sys/class/grip_sensor/snt8100fsr/set_reg
	...
	echo 0x200 0x8101 0x0000 0xffff 0x1400 0x0001 0x0000 > /sys/class/grip_sensor/snt8100fsr/set_reg
	echo 0x2c 0x0000 0 0x0b03 > /sys/class/grip_sensor/snt8100fsr/set_reg
    echo 110 6 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
    sleep 1
    setprop persist.grip.calibration_done 1
